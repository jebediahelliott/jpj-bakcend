    ...
    return(
      <div>
        ...
        <div className='staticPage'>
          ...
          <p>
            This course is designed to make your dog a better family member and to help gain control in real life situations. the Basic Obedience Program consists of 7 private lessons and 4 free group classes covering heel, wait, sit, stay, down, and recall. It also includes problem areas such as jumping, chewing, digging, etc.
          </p>
          <p>
